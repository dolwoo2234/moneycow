...
const questions = [
    ...
    ISFJ: { title: "다정다감 '스코티시 폴드'", desc: '주변을 세심하게 챙기는 당신! 조용하지만 깊은 사랑을 주는 타입이에요.', image: 'result_scottish_fold.png' },
    ESTP: { title: "천방지축 '아비시니안'", desc: '활동적이고 호기심 많은 당신! 한시도 가만히 있지 않는 에너자이저예요.', image: 'result_abyssinian.png' },
    ESFP: { title: "파티 피플 '뱅갈'", desc: '어디서나 눈에 띄는 당신! 화려한 비주얼과 넘치는 흥을 가진 고양이에요.', image: 'result_bengal.png' },
    ISTP: { title: "독립적인 사냥꾼 '노르웨이 숲'", desc: '혼자서도 잘 지내는 당신! 뛰어난 적응력과 냉철한 판단력을 가졌어요.', image: 'result_norwegian_forest.png' },
    ISFP: { title: "평화주의자 '페르시안'", desc: '싸움을 싫어하고 온화한 당신! 느긋하게 인생을 즐길 줄 아는 예술가예요.', image: 'result_persian.png' },
    ENTJ: { title: "똑똑한 리더 '샴'", desc: '의사표현이 확실하고 똑똑한 당신! 목표를 위해 집사를 조종(?)할 줄 아는 전략가예요.', image: 'result_siamese.png' },
    ENTP: { title: "장난꾸러기 '터키시 앙고라'", desc: '기발한 장난으로 집사를 놀래키는 당신! 똑똑하고 자유로운 영혼이에요.', image: 'result_turkish_angora.png' },
    INTJ: { title: "도도한 천재 '스핑크스'", desc: '독특한 매력과 깊은 통찰력! 남의 시선 따위 신경 쓰지 않는 쿨한 고양이에요.', image: 'result_sphynx.png' },
    INTP: { title: "철학자 고양이 '터키시 반'", desc: '혼자만의 생각에 잠기는 걸 즐기는 당신! 엉뚱하지만 천재적인 면모가 있어요.', image: 'result_turkish_van.png' },
    ENFJ: { title: "인싸 중의 인싸 '데본 렉스'", desc: '모든 사람과 친해지고 싶은 당신! 다정한 성격으로 주변에 온기를 전해요.', image: 'result_devon_rex.png' },
