...
const results = {
    ESTJ: { title: '철저한 지휘관 '호랑이'', desc: '강한 책임감과 리더십! 당신은 숲의 질서를 지키는 든든한 지도자예요.' },
    ESTP: { title: '모험가 '여우'', desc: '두려움 없는 도전 정신! 당신은 위기 상황에서도 기발한 재치를 발휘해요.' },
    ESFJ: { title: '다정한 수호자 '강아지'', desc: '사교적이고 따뜻한 당신! 주변 친구들을 잘 챙기는 친절한 친구예요.' },
    ESFP: { title: '인기쟁이 '돌고래'', desc: '에너지 넘치는 분위기 메이커! 당신은 언제 어디서나 즐거움을 선사해요.' },
    ISTJ: { title: '성실한 일꾼 '개미'', desc: '맡은 일은 끝까지 해내는 당신! 규칙과 질서를 소중히 여기는 신뢰의 상징이에요.' },
    ISTP: { title: '자유로운 사냥꾼 '늑대'', desc: '독립심이 강하고 냉철한 당신! 도구 사용 능력이 뛰어나고 실용적이에요.' },
    ISFJ: { title: '따뜻한 동반자 '사슴'', desc: '차분하고 헌신적인 당신! 조용하지만 주변 사람들에게 큰 힘이 되어줘요.' },
    ISFP: { title: '평화로운 예술가 '고양이'', desc: '온화하고 감수성 풍부한 당신! 현재의 행복을 즐길 줄 아는 낭만파예요.' },
    ENTJ: { title: '카리스마 리더 '사자'', desc: '확신에 찬 결단력! 당신은 목표를 향해 거침없이 나아가는 타고난 리더예요.' },
    ENTP: { title: '창의적인 지략가 '원숭이'', desc: '아이디어가 샘솟는 당신! 고정관념에서 벗어난 새로운 시각을 가졌어요.' },
    INTJ: { title: '냉철한 전략가 '올빼미'', desc: '지적인 통찰력과 분석력! 당신은 미래를 내다보고 계획하는 브레인이에요.' },
    INTP: { title: '사색하는 철학자 '코알라'', desc: '혼자만의 생각에 잠기는 걸 즐기는 당신! 논리적이고 호기심이 아주 많아요.' },
    ENFJ: { title: '친절한 멘토 '판다'', desc: '타인을 진심으로 응원하는 당신! 사람들의 마음을 움직이는 힘이 있어요.' },
    ENFP: { title: '활발한 모험가 '래서판다'', desc: '무한한 긍정 에너지! 당신은 새로운 가능성을 찾아 끊임없이 도전해요.' },
    INFJ: { title: '신비로운 예언가 '유니콘'', desc: '깊은 통찰력과 강한 직관! 당신은 세상을 더 나은 곳으로 만들고 싶어 해요.' },
    INFP: { title: '꿈꾸는 이상가 '토끼'', desc: '몽글몽글 따뜻한 감성! 당신은 자신만의 순수한 내면 세계를 소중히 여겨요.' }
};
